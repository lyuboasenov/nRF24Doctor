...
//**** CONNECTIONS *****
#define ENCODER_A_PIN       3		//Interrupt pin required for Encoder for optimal response
#define ENCODER_B_PIN       2		//Interrupt pin required for Encoder for optimal response
...
#define ADC_PIN_NR           1     	// A5, Match to CURRENT_PIN for configuring registers ADC
